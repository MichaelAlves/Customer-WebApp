...
//The purpose of this class is to send a JSON response with a list of states for the drop-down list data source in the kendo UI filter menu
...
public class States extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            response.getWriter().print(_gson.toJson(d.getStates()));
